...
public partial class NorthwindOriginalContext : DbContext
{
    ...
    public virtual DbSet<ProductsDailySale> ProductsDailySales { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-U63FSCU;Database=NorthwindOriginal;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasIndex(e => e.CategoryName, "CategoryName").HasFillFactor(70);
        ...
        {
            entity.HasIndex(e => e.City, "City").HasFillFactor(70);

            entity.HasIndex(e => e.CompanyName, "CompanyName").HasFillFactor(70);

            entity.HasIndex(e => e.PostalCode, "PostalCode").HasFillFactor(70);

            entity.HasIndex(e => e.Region, "Region").HasFillFactor(70);
        ...
        modelBuilder.Entity<Documentation>(entity =>
        {
            ...
            entity.Property(e => e.AvaibleRoute).HasMaxLength(200);
        ...
        {
            entity.HasIndex(e => e.LastName, "LastName").HasFillFactor(70);
        ...
        {
            entity.HasIndex(e => e.CustomerId, "CustomerID").HasFillFactor(70);

            entity.HasIndex(e => e.CustomerId, "CustomersOrders").HasFillFactor(70);

            entity.HasIndex(e => e.EmployeeId, "EmployeeID").HasFillFactor(70);

            entity.HasIndex(e => e.EmployeeId, "EmployeesOrders").HasFillFactor(70);

            entity.HasIndex(e => e.OrderDate, "OrderDate").HasFillFactor(70);

            entity.HasIndex(e => e.ShipPostalCode, "ShipPostalCode").HasFillFactor(70);

            entity.HasIndex(e => e.ShippedDate, "ShippedDate").HasFillFactor(70);

            entity.HasIndex(e => e.ShipVia, "ShippersOrders").HasFillFactor(70);
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderId, "OrderID").HasFillFactor(70);

            entity.HasIndex(e => e.OrderId, "OrdersOrder_Details").HasFillFactor(70);

            entity.HasIndex(e => e.ProductId, "ProductID").HasFillFactor(70);

            entity.HasIndex(e => e.ProductId, "ProductsOrder_Details").HasFillFactor(70);
        ...
        {
            entity.HasIndex(e => e.CategoryId, "CategoriesProducts").HasFillFactor(70);

            entity.HasIndex(e => e.CategoryId, "CategoryID").HasFillFactor(70);

            entity.HasIndex(e => e.ProductName, "ProductName").HasFillFactor(70);

            entity.HasIndex(e => e.SupplierId, "SupplierID").HasFillFactor(70);

            entity.HasIndex(e => e.SupplierId, "SuppliersProducts").HasFillFactor(70);
        ...
        modelBuilder.Entity<Shipper>(entity =>
        {
            ...
            entity.HasOne(d => d.Region).WithMany(p => p.Shippers)
